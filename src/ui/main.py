...
with window("Main Window"):
    widget = add_input_text("Aidan##inputtext")
    ...
    add_input_text("Multiline##inputtext", multiline=True, callback=button_callback, callback_data="Some Data")
    # add_button("Retrieve2", callback=button_callback, callback_data=get_value(widget))
