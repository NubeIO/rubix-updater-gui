...
#
#
# bios_token = bios_get_token(HOST)
# print(bios_token)
#
#
# def bios_add_git_token(host, access_token):
...
#
#
# print(bios_add_git_token(HOST, bios_token))
#
#
...
#
#
# # print(install_rubix_service(HOST, bios_token))
#
#
...
#
#
# rubix_token = get_rubix_service_token(HOST)
# print(rubix_token)
#
#
# def rubix_add_git_token(host, access_token):
...
#
#
# rubix_add_git_token(HOST, rubix_token)
#
#
...
#
#
# install_wires_plat(HOST, rubix_token)